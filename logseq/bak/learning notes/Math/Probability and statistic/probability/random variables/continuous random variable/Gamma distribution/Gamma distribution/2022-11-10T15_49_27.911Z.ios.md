...
A [[random variable]] $Y$ is saint to have a gamma distribution with parameters $\alpha > 0$ and $\beta > 0$ if and only if the density function of $Y$ is 
$f(y) = {\begin{aligned}\frac{y^{\alpha-1}e^{-y/\beta}}{\beta ^\alpha \gamma(\alpha)} , y \geq 0 \\ 0 , y < 0 \end{aligned}}$
$\gamma(\alpha)$ is the [[Gamma function]] 
# snape of the [[probability density function]] 
...
# the [[expected value]]  of [[Gamma distribution]] 
$E[Y] = \alpha\beta$ 
## proof
$E[Y] = 
